...
import { argTypeHidden, argTypeColor } from '../../utils/utils';
  ...
  html`
    <outline-container>
      <outline-card
        ...
        bg-color-header="${ifDefined(bgColorHeader)}"
        bg-color-content="${ifDefined(bgColorContent)}"
        bg-color-footer="${ifDefined(bgColorFooter)}"
      >
          ${cardHeader}
          ${cardContent}
          ${cardFooter}
...
CardWithImageHeader.args = {
  ...
  `,
  bgColorFooter: 'gray-200',
  bgColorContent: 'gray-50',
  isRounded: true,
  hasShadow: true,
};
  ...
  html`
    <outline-container>
      <outline-card
        has-shadow="true"
        is-rounded="true"
        bg-color-header="brand-blue"
        bg-color-content="gray-50"
        bg-color-footer="gray-200"
      >
        <div slot="header">
          <outline-heading
            level="2"
...
CardWithFooter.args = {
  cardFooter: html`
    <div slot="footer" class="p-4">
      <outline-header sub>Generic Footer</outline-header>
    </div>
  `,
};
